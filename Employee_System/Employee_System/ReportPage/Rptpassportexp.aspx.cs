...
{
    public partial class Rptpassportexp : System.Web.UI.Page
    {
     ...
     //   ReportData RD = new ReportData();
        ...
        public void BindRDLC()
        {
            try
            {
                ...
                objdt = rpt.ReportListPassport();
                ReportDataSource Rds = new ReportDataSource();
                Rds.Name = "DataSet1";
                Rds.Value = objdt;
                ReportViewer1.ProcessingMode = ProcessingMode.Local;
                ReportViewer1.LocalReport.DataSources.Clear();
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/Rpt_Passport.rdlc");
