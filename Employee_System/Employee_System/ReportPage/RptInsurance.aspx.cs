...
{
    public partial class RptInsurance : System.Web.UI.Page
    {
        ...
        public void BindRDLC()
        {
            try
            {
                ...
                rpt.Ptype = Convert.ToInt32(DropDownList1.SelectedValue);
                objdt = rpt.ReportListinsurance();
                ReportDataSource Rds = new ReportDataSource();
                Rds.Name = "DataSet1";
                Rds.Value = objdt;
                ReportViewer1.ProcessingMode = ProcessingMode.Local;
                ReportViewer1.LocalReport.DataSources.Clear();
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/Rpt_insurance.rdlc");
